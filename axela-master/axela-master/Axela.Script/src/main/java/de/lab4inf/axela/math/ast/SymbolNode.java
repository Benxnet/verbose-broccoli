...
/**
 * Node for symbolic constants.
 * 
 * @author nwulff
 * @since 26.10.2020
 */
public class SymbolNode extends BasicNode<String> {

	/**
	 * Node for constant symbols.
	 * 
	 * @param symbol of this node
	 */
	 ...
	 * @param symbol of this node
	 */
	public SymbolNode(Node<?> parent, String symbol) {
