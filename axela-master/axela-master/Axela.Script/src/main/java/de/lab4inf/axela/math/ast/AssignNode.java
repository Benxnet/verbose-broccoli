 ...
 * @since 26.10.2020
 */
public class AssignNode extends MathOperatorNode {
	/**
	 * Pojo constructor.
	 */
	public AssignNode() {
		super(AstOperator.ASSIGN);
	}

	/**
	 * Assign the left symbol to the right expression
	 * 
	 * @param left  a symbol
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.lab4inf.axela.math.ast.MathOperatorNode#isCommutative()
	 */
	@Override
